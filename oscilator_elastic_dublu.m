...
m1=0.35; m2=0.15; % kg; masele corpurilor
...
for i=2:N-1
    ...
    eta1(i+1)=2*eta1(i)-eta1(i-1)-dt^2*(omega11^2*eta1(i)-omega12^2*eta2(i));

    eta2(i+1)=2*eta2(i)-eta2(i-1)-dt^2*(omega22^2*eta2(i)-omega21^2*eta1(i));
